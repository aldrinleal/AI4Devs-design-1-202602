...
Documenta todo en un único documento markdown (.md) con el nombre LTI-iniciales, y déjalo en una carpeta con el mismo nombre, dentro de la carpeta lti, en el repositorio Github de este tema:
